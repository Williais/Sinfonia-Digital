...
export default function MusicDetailScreen() {
  ...
  if (!musica) return <View style={styles.center}><Text style={{color:'#FFF'}}>Música não encontrada</Text></View>;
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.playerSection}>
        ...
        <Text style={styles.statusText}>
          {musica.audioUrl ? (isPlaying ? 'Tocando...' : 'Toque para ouvir') : 'Áudio indisponível'}
        </Text>
      </View>
