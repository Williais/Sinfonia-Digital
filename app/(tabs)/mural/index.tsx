  ...
  async function handleSave() {
    ...
    try {
      if (editId) {
        await supabase
          .from("notices")
          .update({ title: titulo, content: conteudo, priority: prioridade })
          .eq("id", editId);
      } else {
        await supabase
          .from("notices")
          .insert({ title: titulo, content: conteudo, priority: prioridade });
      }

      if (notify) {
        const prefixo =
          prioridade === "alta" ? "🚨 AVISO URGENTE: " : "📢 NOVO AVISO: ";
          ...
          <View style={styles.modalContainer}>
            ...
            <View style={styles.row}>
              <TouchableOpacity
                style={[
                  styles.optBtn,
                  prioridade === "baixa" && styles.optBaixa,
                ]}
                onPress={() => setPrioridade("baixa")}
              >
                <Text style={styles.optText}>Baixa</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[
                  styles.optBtn,
                  prioridade === "media" && styles.optMedia,
                ]}
              ...
              <TouchableOpacity
                style={[styles.optBtn, prioridade === "alta" && styles.optAlta]}
                onPress={() => setPrioridade("alta")}
              >
                <Text style={styles.optText}>Alta</Text>
              </TouchableOpacity>
            </View>
            ...
            >
              {saving ? (
                ...
                <>
                  ...
                  <Text style={styles.saveText}>Salvar Aviso</Text>
                </>
              )}
            </TouchableOpacity>
          </View>
