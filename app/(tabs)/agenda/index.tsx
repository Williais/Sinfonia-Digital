...
export default function AgendaScreen() {
  ...
  const [filtro, setFiltro] = useState<
    "todos" | "ensaio" | "concerto" | "apresentacao"
  >("todos");
  ...
  const FilterChip = ({
    ...
    <TouchableOpacity
      ...
      onPress={() => {
        setFiltro(type);
        aplicarFiltro(eventos, type);
      }}
    >
      <Text style={[styles.chipText, filtro === type && styles.chipTextActive]}>
        {label}
      </Text>
    </TouchableOpacity>
  );
  ...
  const TypeOption = ({
    ...
    >
      <Text
        style={[styles.typeTextOption, novoTipo === value && { color: "#FFF" }]}
      >
        {label}
      </Text>
    </TouchableOpacity>
            ...
            <View style={styles.cardHeader}>
              ...
              >
                {isCancelado ? (
                  ...
                  <View style={styles.badgeAdiado}>
                    <AlertTriangle size={12} color="#000" />
                    <Text style={styles.badgeTextDark}>ADIADO</Text>
                  </View>
                ) : (
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContainer}>
            ...
            >
              ...
              <TextInput
                style={styles.input}
                placeholder="Ex: Ensaio de Naipe"
              ...
              <TextInput
                ...
                placeholder="Detalhes, repertório..."
                placeholderTextColor="#666"
                multiline
                numberOfLines={3}
                value={novaDescricao}
