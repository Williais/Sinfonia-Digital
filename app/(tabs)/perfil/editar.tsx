...
import { Camera, ChevronLeft, Instagram, Save } from "lucide-react-native";
...
export default function EditarPerfilScreen() {
  ...
  const [instrumentOwnership, setInstrumentOwnership] = useState<
    "proprio" | "cefec"
  >("proprio");
  ...
  const displayImage =
    newAvatarUri || avatarUrl || "https://github.com/shadcn.png";
        ...
        <View style={styles.inputGroup}>
          ...
          <View style={styles.switchContainer}>
            <TouchableOpacity
              style={[
                styles.switchOption,
                instrumentOwnership === "proprio" && styles.switchActive,
              ]}
            ...
            >
              <Text
                style={[
                  styles.switchText,
                  instrumentOwnership === "proprio" && styles.switchTextActive,
                ]}
              >
                Próprio
              </Text>
            ...
            <TouchableOpacity
              style={[
                styles.switchOption,
                instrumentOwnership === "cefec" && styles.switchActive,
              ]}
            ...
            >
              <Text
                style={[
                  styles.switchText,
                  instrumentOwnership === "cefec" && styles.switchTextActive,
                ]}
              >
                Do CEFEC
              </Text>
