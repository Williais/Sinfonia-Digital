        ...
        <View style={styles.profileCard}>
          ...
          <View>
            ...
            <Text style={styles.instrument}>
              {profile?.instrument} •{" "}
              {profile?.role === "admin" ? "Maestro/Admin" : "Músico"}
            </Text>
            <View
              style={[
                styles.levelBadge,
          ...
          <View style={styles.progressBarBg}>
            <View
              style={[
                ...
                { width: `${progresso * 100}%`, backgroundColor: levelColor },
              ]}
            />
          </View>
        </View>
      ...
      {badges.length > 0 ? (
        ...
        <View style={styles.emptyBadges}>
          ...
          <Text style={styles.emptyText}>
            Participe dos eventos para ganhar selos!
          </Text>
        </View>
      )}
